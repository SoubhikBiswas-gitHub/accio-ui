...
// import db from "./subscription/firebase";
...
function Footer() {
    ...
    const handleSubmit = (e) => {
      ...
      let timeDate =time+" "+new Date().toLocaleDateString();
        e.preventDefault()
        if(email){
        ...
        //   time:timeDate,
        //  })
        fetch('https://accio-job-test-db-default-rtdb.asia-southeast1.firebasedatabase.app/message.json',
        {
          method:'POST',
  ...
  return (
    <div className="footerContainer">
      <div className="topFooter">
        <div className="logo">Acciojob</div>
        <div className="link">
          <ul>
            <li>
              <a
      ...
      <div className="midFooter">
        <div className="main-container">
          ...
          <div className="subcontainerMail">
            <h5>Get In Touch</h5>
